...
public class RealTimeData {
	 ...
	 */
	public RealTimeData(int type, String fullCode, String name, double now, double volume, double volumePrice,
	 ...
	 * @param time 时间
	 */
	public RealTimeData(int type, String fullCode, String name, double open, double close, double now, double high,
